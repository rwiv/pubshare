...
export default class AnimationHelper {
  ...
  public readonly animate_spin = css`animation: ${
    keyframes`
      from {
  ...
  public readonly animate_ping = css`animation: ${
    keyframes`
      75%, 100% {
        transform: scale(2);
        opacity: 0;
  ...
  public readonly animate_pulse = css`animation: ${
    keyframes`
      0%, 100% {
        opacity: 1;
      }
  ...
  public readonly animate_bounce = css`animation: ${
    keyframes`
      0%, 100% {
