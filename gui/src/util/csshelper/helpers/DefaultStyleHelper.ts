...
export default class DefaultStyleHelper {
  ...
  public px = (value: number) => css({ paddingLeft: `${value}rem`, paddingRight: `${value}rem` });
  public py = (value: number) => css({ paddingTop: `${value}rem`, paddingBottom: `${value}rem` });
  ...
  public border_st = (value: "solid" | "dashed" | "dotted" | "double" | "hidden" | "none") => css({ borderStyle: value });

  public m = (value: number) => css({ margin: `${value}rem` });
  public mx = (value: number) => css({ marginLeft: `${value}rem`, marginRight: `${value}rem` });
  public my = (value: number) => css({ marginTop: `${value}rem`, marginBottom: `${value}rem` });
